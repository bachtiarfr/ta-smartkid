        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="tel:123343434">
                        <div class="service-item text-center pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-phone text-primary mb-4"></i>
                                <h5 class="mb-3">Hubungi Via Telepon</h5>
                                <p>+628 123456</p>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="mailto:beasiswasmartkid@gmail.com">
                        <div class="service-item text-center pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-envelope text-primary mb-4"></i>
                                <h5 class="mb-3">Hubungi Via Email</h5>
                                <p>beasiswasmartkid@gmail.com</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a href="beasiswasmartkid.online">
                        <div class="service-item text-center pt-3">
                            <div class="p-4">
                                <i class="fa fa-3x fa-globe text-primary mb-4"></i>
                                <h5 class="mb-3">Alamat website</h5>
                                <p>beasiswasmartkid.online</p>
                            </div>
                        </div>
                    </a>
                </div>
                <div class="col-lg-12 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <p>JALAN LETNAN TUKIYAT KOTA MUNGKID, Deyangan, Kec. Mertoyudan, Kab. Magelang Prov. Jawa Tengah</p>
                        </div>
                    </div>
                </div>
            </div>
