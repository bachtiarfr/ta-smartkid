...
@section('title', 'Data Kriteria Kepemilikan Ternak')

@section('content_header')
    <h1>Data Kriteria Kepemilikan Hewan Ternak</h1>
@stop
                        ...
                        console.log(val);
                         baris += `
                            <tr>
                                ...
                                <td>
                                    @if ( $no == 1 )
                                        <a class="btn btn-warning" href="{{ URL::to('admin/editternak/${val.ternak_id}') }}"> Ubah </a>
