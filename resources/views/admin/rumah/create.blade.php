        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-header">
                    <strong>Data Tentang Kondisi Tempat Tinggal</strong>
                    <small>diisi sesuai kondisi</small>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-sm-4">
                            <label for="ccmonth"> Keterangan Tempat Tinggal </label>
...
@section('js')
    <script>
        $(function () {
            ...
            // fungsi simpan data rumah detail berupa array
